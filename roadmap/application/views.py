...
def plotpage():
    ...
    import pickle
    with open('john.pickle', 'w') as f:
        pickle.dump([title_list, fig_list, summary_list, skillKey, url_list, title_list1, fig_list1, summary_list1, skillKey1, url_list1, percentTF, percentSM],f)
